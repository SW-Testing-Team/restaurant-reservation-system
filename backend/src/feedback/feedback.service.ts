...
import {
  RestaurantFeedback,
  RestaurantFeedbackDocument,
} from './schemas/restaurant-feedback.schema';
import {
  ItemFeedback,
  ItemFeedbackDocument,
} from './schemas/menu-item-feedback.schema';
...
export class FeedbackService {
  constructor(
    ...
    private restaurantFeedback: Model<RestaurantFeedbackDocument>,
    @InjectModel(ItemFeedback.name)
    private itemFeedback: Model<ItemFeedbackDocument>,
  ) {}
